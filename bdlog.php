...
// ВНИМАНИЕ! заполнить нижеследующую строку так: 
    ...
    $dbhost="sql4.freesqldatabase.com"; //хост базы данных
    $dbuser="sql4397593"; //имя пользователя базы данных
    $dbpass="BQ6LkbuYKD"; // пароль базы данных
    $db_name="sql4397593"; // название базы данных
